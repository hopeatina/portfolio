...
const toolEvidence: ToolEvidence[] = [
  ...
  { name: "Rust", icon: "rust", category: "Runtime", project: "Perf Pulse", reason: "A small local core lets Crash Guard watch memory and disk headroom without becoming the workload it is protecting against." },
...
const range = [
  ...
  },
  {
    ...
    thesis: "Crash Guard for runaway memory and shrinking disk headroom.",
    constraint: "Always-on warnings. One local incident surface. Deliberate intervention.",
