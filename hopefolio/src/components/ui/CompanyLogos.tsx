...
const companies: Company[] = [
  {
    ...
    impact: "Therapist adoption 40% → 89% with AI-powered reassessments",
    environment: "Mental health • HIPAA-compliant production",
    shipped: "Automated reassessments, compliant documentation workflows",
  },
  {
    name: "Vessel Health",
    ...
    impact: "Backend re-architecture with 93% bug reduction",
  ...
  },
  {
    ...
    impact: "Automated ETL pipelines and enterprise Snowflake onboarding",
    environment: "Enterprise data • high-scale internal systems",
    shipped: "Spark/Scala pipelines, warehouse operations, automation",
  },
  {
    name: "MD Anderson",
    ...
    role: "Research",
    impact: "Bioengineering research with production-minded systems thinking",
    environment: "Research • scientific computing",
    shipped: "Modeling, experimentation, infrastructure-adjacent research",
  },
];
